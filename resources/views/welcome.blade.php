    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    <a href="{{ url('/booking') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Booking</a>
                @else
                    <a href="{{ route('login') }}"
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Sewa Mobil</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Kami memahami betapa pentingnya mobilitas yang nyaman dan fleksibel dalam perjalanan
                                Anda. Oleh karena itu, kami menawarkan koleksi mobil terbaik dengan berbagai pilihan
                                yang akan memenuhi segala kebutuhan perjalanan Anda. Apakah Anda mencari mobil keluarga
                                yang luas, mobil mewah yang elegan, atau kendaraan kompak yang ekonomis, kami memiliki
                                semuanya!
                            </p>
                        </div>
                    </a>
                    ...
                    <a class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                lokasi penjemputan Anda. Selain itu, Anda dapat menyaring hasil pencarian berdasarkan
                                preferensi pribadi Anda, seperti jenis mobil, transmisi, atau fasilitas tambahan yang
                                Anda butuhkan. </p>
                        </div>
                    </a>
                    ...
                    <a class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                menyenangkan, Anda dapat merencanakan perjalanan Anda dengan tenang dan yakin bahwa Anda
                                mendapatkan nilai terbaik untuk uang Anda. </p>
                        </div>
                    </a>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                24/7, kami akan dengan senang hati menjawab pertanyaan Anda dan mengatasi setiap
                                permintaan khusus yang Anda miliki. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                    <div class="flex items-center gap-4">
                        <a href="https://instagram.com/ankabakie?igshid=NjIwNzIyMDk2Mg=="
